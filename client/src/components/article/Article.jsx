...
function Article() {
  ...
  //modify article and disable edit state
    ...
    {articleEditStatus === false ? (
      <>
        <div className="d-flex justify-content-between">
          <div>
            <p className="display-3 fs-3 fw-bold me-4">{state.title}</p>
            <span className="py-3">
        ...
        <div>
          ...
          <div className="comments my-4">
            {state.comments.length === 0 ? (
              <p className="display-3 fs-4 fw-bold">No comments yet...</p>
            ) : (
          ...
          <h1 className="display-3 fs-4 fw-bold">{comment}</h1>
      ...
      <form onSubmit={handleSubmit(saveModifiedArticle)} className="display-4 fs-4 fw-semibold">
        <div className="mb-4">
